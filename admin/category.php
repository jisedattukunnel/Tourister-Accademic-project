...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <?php
        ...
        $con=  mysqli_query($con, "select * from category");
        ?>

        <div class="container">
            <h1>Categories</h1>
            <br><br>      <br><br>
            <a href="addcategory.php"><button style="margin-left: 50px;"  type="sign-up"  class="btn btn-success">Add New Category</button></a>
        ...
        <tr>
            ...
            <td><?php echo "<a href='deletecategory.php?id=".$row['id']."'><button>DELETE</button></a>"; ?></td>
