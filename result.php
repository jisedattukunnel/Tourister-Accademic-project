...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-dark" id="ftco-navbar" style="background-color: #f85959;color: #fff;">
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
			<h3>Looking for <?php echo $_SESSION["place"]; ?></h3>
        <div class="row">
        	<div class="col-lg-3 sidebar ftco-animate">
        		<div class="sidebar-wrap bg-light ftco-animate">
              <h3 class="heading mb-4">Find <?php echo $_SESSION["place"]; ?></h3>
            ...
            ?>
                  ...
                  <a href="fiter.php?id=<?php echo $row['category']; ?>""><input type="button" class="form-control" value="<?php echo $row['category']; ?>"></a>
		              </div>
                </div>
                <?php endwhile; ?>
          ...
          <div class="col-lg-9">
          	<div class="row">
						...
						<?php
              $db = new mysqli("localhost","root","","tourister");
              $query = "SELECT * FROM register WHERE spot = '".$_SESSION["place"]."' and state ='true'";
              $sql = $db->query($query);
            ?>
						<?php while($row = $sql->fetch_assoc()): ?>
          		<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
                        <h3><a href="view.php?id=<?php echo $row['id']; ?>""><?php echo $row['name']; ?></a></h3>
                        <a href="view.php"></a>
                    ...
                    <p class="days">Working time: <span><?php echo $row['timefrom']; ?> to <?php echo $row['timeto']; ?></span></p>

		    						<hr>
		    						<p class="bottom-area d-flex">
                      <span><i class="icon-map-o"></i> <?php echo $row['street']; ?>,<?php echo $row['village']; ?></span>
		    							<span class="ml-auto"><a href="view.php?id=<?php echo $row['id']; ?>">Details</a></span>
                    </p>
		    					</div>
		    				</div>
		    			</div>
