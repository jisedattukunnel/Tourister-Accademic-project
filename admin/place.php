...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <?php
        ...
        $con=  mysqli_query($con, "select * from place");
        ?>

        <div class="container">
            <h1>Tourist Places</h1>
            <br><br>
            <a href="addplace.php"><button style="margin-left: 50px;"  type="sign-up"  class="btn btn-success">Add New Place</button></a>
        ...
        <tr>
            ...
            <td><?php echo "<a href='deleteplace.php?id=".$row['id']."'><button>Delete</button></a>"; ?></td>
