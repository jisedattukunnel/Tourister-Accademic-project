...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <?php
        ...
        $con=  mysqli_query($con, "select * from register WHERE state='false'");
        ?>
        ...
        <div class="container">
          ...
          <th bgcolor="grey">Mobile</th>
          <th bgcolor="grey">Email</th>
          <th bgcolor="grey">Category</th>
          <th bgcolor="grey">Spot</th>
          <th bgcolor="grey"></th>
        </tr>
        <?php
      ...
      <div class="row block-9">
        <div class="col-md-2 pr-md-5">
          ...
          <div style="margin-left: 70px;" class="col-md-4 pr-md-5">
            ...
            <td>
              <form action="adminservices/admin-approve-process.php?id=<?php echo $row['id']; ?>" method="post" role="approve">
              <button name="approve">Approve</button>
            </form>
            </td>
          </div>
          <div class="col-md-6 heading-section ftco-animate" align="right"> </div> </div>
        </div>
      </div>
    </div>

          <form action="adminservices/admin-approve-process.php" method="post" role="approve">
